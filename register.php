...
<div class="container-fluid">
		...
		<div class="forms col-sm-4">
			...
			<form action="register.php" method="POST" id="reg_form">
				<div class="input-field">
					...
					<input class="form-control btn btn-lg btn-info btn-block" type="submit" id="register_form" name="register_button" value="Signup">
			    </div>
			</form>		
		</div>
	</div>
	...
	<div class="footer">
		...
		<span class="rights">All Rights Reserved. &copy; Bhilwara Network.</span>
